...
public class LANBroadcastService : MonoBehaviour
{
    ...
    private int udpPortNumber = 17984;
    ...
    void Update()
    {
            ...
            && Time.time > fTimeLastMessageSent + fIntervalMessageSending)
        {
            ...
            objUDPClient.Send(objByteMessageToSend, objByteMessageToSend.Length, new IPEndPoint(IPAddress.Broadcast, udpPortNumber));
            // Restart the timer
    ...
    private void StartBroadcastingSession()
    {
        ...
        // Create the client
        objUDPClient = new UdpClient(udpPortNumber);
